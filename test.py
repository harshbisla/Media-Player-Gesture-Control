...
classifier = Classifier("C:/Users/Harsh Bisla/OneDrive/Desktop/machine learnig/media_gesture_control/model/Keras_model.h5","C:/Users/Harsh Bisla/OneDrive/Desktop/machine learnig/media_gesture_control/model/labels.txt")
...
# folder = "C"
# counter = 0
labels =["vol_up","vol_down","play / pause"]
...
while True: 
    ...
    if hands:#cropping the image of hand
        ...
        cv2.rectangle(imgOutput,(x-offset,y-offset-50),(x-offset+200,y-offset),(255,0,255),cv2.FILLED)
